    ...
    function updateHistoryDisplay() {
        ...
        sortedKeys.forEach((key) => {
            ...
            items.forEach((item) => {
                ...
                span.innerHTML = `Semana do ano: <strong>${item.Semana}</strong> <br> Data: <strong>${formatDate(new Date(item.data))}</strong> <br>  Ganhos: <strong>${item.ganhos}</strong> <br> Líquido: <strong>${item.resultado}</strong>`;
