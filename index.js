    ...
    function updateHistoryDisplay() {
        ...
        sortedKeys.forEach((key) => {
            ...
            items.forEach((item) => {
                ...
                span.textContent = `Semana do ano: <trong>${item.Semana},</strong> Data: <strong>${formatDate(new Date(item.data))}</strong>, Ganhos: <strong>${item.ganhos}</strong>, Líquido: <strong>${item.resultado}</strong>`;
